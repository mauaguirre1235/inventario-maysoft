...
<div class="max-w-2xl mx-auto bg-white rounded shadow p-8 mt-8">
	<h2 class="text-xl font-bold mb-6">Registrar nuevo equipo</h2>
	...
	<div class="flex justify-end gap-2 mt-6">
		<a href="{{ route('inventarios.index') }}" class="bg-gray-200 px-4 py-2 rounded hover:bg-gray-300">Cancelar</a>
		<button type="submit" class="bg-blue-600 text-white px-4 py-2 rounded hover:bg-blue-700">Guardar equipo</button>
	</div>
	</form>
</div>
...
<script>
	document.addEventListener('DOMContentLoaded', function() {
		...
		toggleFields(); // Para el valor inicial
	});
</script>
